...
export default function MyProjects() {
  return (
    <div id="Projects"  className='py-8 md:py-20 bg-slate-900'>
            ...
            <a
              ...
              <div className="flex relative ">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100 h-60 rounded-3xl">
                  <h2 className="tracking-widest text-xs md:text-sm title-font font-medium text-green-400 mb-1">
                    {project.subtitle}
                  </h2>
                  <h1 className="title-font text-lg font-medium text-white mb-3">
                    {project.title}
                  </h1>
                  <p className="leading-relaxed text-xs md:text-sm md:text-lg">{project.description}</p>
                </div>
              </div>
            </a>
          ))}
