  ...
  return (
    <div id='About' className='flex items-center justify-around pb-20'>
       ...
       <div className='z-40 p-5 w-2/5'> 
            ...
            <h2 className='text-2xl mb-2'>Salut , je m'appelle <span className='text-fuchsia-900 font-bold'>Noâ</span> <br></br> et je suis développeuse Front-end / React.</h2>
           ...
           <a href='#Contact' className='text-xl rounded-full p-4 bg-gradient-to-l from-purple-700 to-blue-800 shadow-2xl'>Me contacter &gt; &gt;</a>
        </div>
